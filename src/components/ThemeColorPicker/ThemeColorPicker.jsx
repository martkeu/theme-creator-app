...
function ThemeColorPicker({ isCreateView, onAddTheme }) {
						...
						<div className="theme-form__colors picker__color-card">
							<span>
								...
								<input
									...
									value={hexValue1}
									onChange={(event) =>
										setHexValue1(event.target.value)
									}
								/>
								<span>Primary</span>
								<input
							...
							<span>
								...
								<input
									...
									value={hexValue2}
									onChange={(event) =>
										setHexValue2(event.target.value)
									}
								/>
								<span>Secondary</span>
								<input
							...
							<span>
								...
								<input
									...
									value={hexValue3}
									onChange={(event) =>
										setHexValue3(event.target.value)
									}
								/>
								<span>Surface</span>
								<input
							...
							<span>
								...
								<input
									...
									value={hexValue4}
									onChange={(event) =>
										setHexValue4(event.target.value)
									}
								/>
