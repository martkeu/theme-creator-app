		...
		<form className="theme-form" onSubmit={handleSubmit}>
			...
			<div className="theme-form__fields">
				<div className="theme-form__field">
                    ...
                    <input type="text" name="title" id="title" defaultValue={theme.name} required/>
                </div>
                ...
                <div className="theme-form__field">
                    ...
                    <div>
                        ...
                        <input type="color" name="color1" id="color1" defaultValue={theme.colors[0].value} />
                    </div>
                    <div>
					    <label htmlFor="color2" className="screen-reader-only">Color 1</label>
                        <input type="color" name="color2" id="color2" defaultValue={theme.colors[1].value} />
                    </div>
                    <div>
					    <label htmlFor="color3" className="screen-reader-only">Color 1</label>
                        <input type="color" name="color3" id="color3" defaultValue={theme.colors[2].value} />
                    </div>
                    <div>
					    <label htmlFor="color4" className="screen-reader-only">Color 1</label>
                        <input type="color" name="color4" id="color4" defaultValue={theme.colors[3].value} />
                    </div>
                </div>
